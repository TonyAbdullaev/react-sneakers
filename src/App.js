  ...
  <div className="wrapper clear">
    <header className="d-flex justify-between align-center p-30">
      <div className="d-flex align-center">
        <img height={40} width={40} src="/img/logo.svg" alt="logo" />
    ...
    <div className="content p-40">  
      ...
      <div className="d-flex justify-between">
        ...
        <div className="card">
          <img heigth={112} width={133} src="/img/sneakers/air max.jpg" alt="sneaker" />
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Price:</span>
        ...
        <div className="card">
          <img heigth={112} width={133} src="/img/sneakers/blazer-white.jpg" alt="sneaker" />
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Price:</span>
        ...
        <div className="card">
          <img heigth={112} width={133} src="/img/sneakers/Aka-boku.jpg" alt="sneaker" />
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Price:</span>
